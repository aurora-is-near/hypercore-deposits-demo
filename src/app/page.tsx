  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="fixed top-4 right-4 z-10 flex items-center gap-3">
        <span className="text-[11px] text-white/35">Build your own Hyperliquid deposit →</span>
        <a
          href="https://github.com/aurora-is-near/hypercore-deposits-demo"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs text-white/60 backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10 hover:text-white/90"
        >
